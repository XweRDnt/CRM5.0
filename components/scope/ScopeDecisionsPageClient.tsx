...
export function ScopeDecisionsPageClient({
  initialDecisions,
}: {
  initialDecisions: ScopeDecisionResponse[];
}): JSX.Element {
  const { data, error, isLoading, mutate } = useSWR("/api/scope/decisions", apiFetch<ScopeDecisionResponse[]>, {
    fallbackData: initialDecisions,

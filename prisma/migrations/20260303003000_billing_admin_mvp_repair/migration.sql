-- Recovery migration for environments where billing admin migration failed.
-- Idempotent by design.

DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'BillingPlanCode') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'WorkspaceSubscriptionStatus') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'WorkspaceBillingCycle') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'WorkspaceSubscriptionEventType') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'WorkspaceSubscription_workspaceId_fkey') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'WorkspaceSubscription_planCode_fkey') THEN
    ALTER TABLE "WorkspaceSubscription"
      ADD CONSTRAINT "WorkspaceSubscription_planCode_fkey"
      FOREIGN KEY ("planCode") REFERENCES "BillingPlan"("code") ON DELETE RESTRICT ON UPDATE CASCADE;
  END IF;
END
$$;
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'WorkspaceSubscription_assignedByUserId_fkey') THEN
    ALTER TABLE "WorkspaceSubscription"
      ADD CONSTRAINT "WorkspaceSubscription_assignedByUserId_fkey"
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'WorkspaceSubscriptionEvent_workspaceId_fkey') THEN
    ALTER TABLE "WorkspaceSubscriptionEvent"
      ADD CONSTRAINT "WorkspaceSubscriptionEvent_workspaceId_fkey"
      FOREIGN KEY ("workspaceId") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE CASCADE;
  END IF;
END
$$;
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'WorkspaceSubscriptionEvent_workspaceSubscriptionId_fkey') THEN
    ALTER TABLE "WorkspaceSubscriptionEvent"
      ADD CONSTRAINT "WorkspaceSubscriptionEvent_workspaceSubscriptionId_fkey"
      FOREIGN KEY ("workspaceSubscriptionId") REFERENCES "WorkspaceSubscription"("id") ON DELETE CASCADE ON UPDATE CASCADE;
  END IF;
END
$$;
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'WorkspaceSubscriptionEvent_actorUserId_fkey') THEN
    ALTER TABLE "WorkspaceSubscriptionEvent"
      ADD CONSTRAINT "WorkspaceSubscriptionEvent_actorUserId_fkey"
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'KinescopeUsageSnapshot_workspaceId_fkey') THEN
    ALTER TABLE "KinescopeUsageSnapshot"
      ADD CONSTRAINT "KinescopeUsageSnapshot_workspaceId_fkey"
      FOREIGN KEY ("workspaceId") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE CASCADE;
  END IF;
END
$$;
